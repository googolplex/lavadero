...
@Entity
@Table(name="LV_DIRECCIONESCLIENTES",
uniqueConstraints={
        @UniqueConstraint(name="dc_no_repetir_direccion", columnNames={"direccion","ciudad","barrio"})        
    })
public class DireccionesClientes extends SuperClaseFeliz {

	@ManyToOne
	@JoinColumn(name="CLIENTE_ID")
	private Clientes empleado ;	
